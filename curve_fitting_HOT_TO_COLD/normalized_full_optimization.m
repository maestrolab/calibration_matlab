...
%%%% use lower-case to tell user which folder to use %%%%
...
if filename == "numerical_experimental_comparison"
    ...
    beq = [];
    lb = [80e9, -1e5, ...
         273.15 + 0, 0., 273.15 - 50, -1e1, 4e4, 4e6, ...
         1e-6, 0., 0.001e-8, ...
         0., 0., 0., 0., ...
         0., 0];
...
fun = @(x)normalized_full_cost(x, lb, ub, filename);
figure(1)
nonlcon = [];
hold on
...
normalized_full_plot_optimized(x, lb, ub, filename)
