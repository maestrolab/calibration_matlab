...
to_plot_cost = ['temperature-strain'];
experiment = process_data(filepath, stress_in_MPa, reorder, tare_strain);
...
lb = [50e8, -5e100, ...
     273.15 + 10, 0, 0, 0, 4E4, 4E6, ...
     0, 0.001e-8, 0., 0.0001e-8,  ...
     0., 0., 0., 0., ...
     0., 0, ...
     1e-3];
% -0.1e-6
...
fun = @(x)cost(x, lb, ub, MVF_0, to_plot_cost);
nonlcon = [];
